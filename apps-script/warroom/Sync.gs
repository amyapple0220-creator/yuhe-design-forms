...
// 來源:github.com/amyapple0220-creator/yuhe-design-forms(apps-script/warroom/)
// ═══════════════════════════════════════════════════════════════

var SYNC_BASE = 'https://raw.githubusercontent.com/amyapple0220-creator/yuhe-design-forms/claude/what-is-this-l7dt44/apps-script/warroom/';
var SYNC_FILES = [
  {
    "name": "appsscript",
    "type": "JSON",
...
function syncFromGitHub() {
  ...
  syncNotify_('🔄 禹合戰情室V3 已自動更新到最新版 ' + deployMsg);
  return 'updated';
}
